...
const FormsManagerSearchBar = function(props) {
    ...
    return <div>
            ...
            {<Dropdown style={{marginLeft:'0.5em'}}  as={ButtonGroup}>
              ...
              <Button  style={{marginLeft:'1em'}} variant="success" onClick={function(e) {props.createEmptyItem(props.listFilterValue)}} >New Form</Button>
...
export default FormsManagerSearchBar
